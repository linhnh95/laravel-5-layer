...
class CreateWebControllerCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'linh-5layer:web-controller';
     ...
     * @var string
     */
    protected $type = 'linh-5layer web controller';
    ...
    {
        return $rootNamespace . DIRECTORY_SEPARATOR . 'Http' . DIRECTORY_SEPARATOR . 'Controllers' . DIRECTORY_SEPARATOR . 'Web';
    }
